...
*******FV**********
************************
use "$RAW/2019-20/fv.dta", clear

* 1. Remove suffixes
rename (*_per_fv) (*)

* 2. Harmonize Location Variables
* (Same logic: FV uses 'b1q4' for District Code)
...
save "$PREP/2019-20_fv_clean.dta", replace
****************
*******RV******
***************
* --- PROCESS RE-VISIT (RV) 2019-20 ---
use "$RAW/2019-20/rv.dta", clear

* 1. Remove suffixes
rename (*_per_rv) (*)

* 2. Harmonize Location Variables
* (Same logic: RV uses 'district' for Code, 'b1q4' for Region)
...
* 4. Standardize Types (CRITICAL FOR 2019-20)
* b4q6 (Age) and b4q10 (Education Years) are strings in this year.
* We must force them to numeric to match 2017/2018.
destring b4q6 b4q10, replace ignore(" ") force
...
save "$PREP/2019-20_rv_clean.dta", replace