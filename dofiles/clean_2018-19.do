...
* --- PROCESS FIRST-VISIT (FV) 2018-19 ---
use "$RAW/2018-19/fv.dta", clear

* 1. Remove suffixes
rename (*_per_fv) (*)

* 2. Harmonize Location Variables
* In FV, 'b1q4' is District Code. (NSS Region is usually 'nss_region')
...
rename b6q5_3pt1_Act1_ industry_day7_act1
...
save "$PREP/2018-19_fv_clean.dta", replace
...
* --- PROCESS RE-VISIT (RV) 2018-19 ---
use "$RAW/2018-19/rv.dta", clear

* 1. Remove suffixes
rename (*_per_rv) (*)

* 2. Harmonize Location Variables
* In RV, 'district' is the code, 'b1q4' is NSS-Region
rename district district_code
rename b1q4 nss_region 

* 3. Keep Variables of Interest (Matching 2017 file)
keep ///
    FI b1q2 quarter visit b1q3 state district_code nss_region ///
    b1q5 b1q6 b1q11 b1q12 fsu b1q13 b1q14 b1q15 b4q1 /// IDs
    b4q4 b4q5 b4q6 b4q7 b4q8 b4q9 b4q10 b4q11 /// Demographics
...
* 4. Standardize Types (Use capture in case they are already numeric)
capture destring b6q9 b6q10 MULT NSS, replace ignore(" ") force
...
save "$PREP/2018-19_rv_clean.dta", replace
